...
main:
  ...
  beq $8, $0, exit			# Exit loop if equal to 0
  ...
  add $11, $8, $8			# add doubled width 
  add $11, $11, $9			# add height
  add $11, $11, $9			# add height again
  
  				# Print "Its perimeter is"
  addi $v0, $0, 4			# system call 4 for printing string
  la $a0, perimeterIs
  syscall
  ...
  j main			# Jump to the beginning of main
